...
tournent dessus, des assistants qu'on met au travail. Derrière le masque, dix-huit ans de
cybersécurité, côté réseau et infrastructure.
...
| Un assistant IA local pour interroger ses documents (vidéo 2) | [`vid-002/`](vid-002/README.fr.md) | la procédure pas à pas avec LM Studio et AnythingLLM, le script qui mesure la vitesse d'un modèle, celui qui observe les connexions de la machine, et les règles de pare-feu pour l'usage hors ligne |
